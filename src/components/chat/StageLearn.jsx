...
export default function StageLearn({ title = "القسم الأول - المرحلة الأولى: الذكاء الاصطناعي", content = "", onBack }) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-2xl font-semibold text-white text-right">محتوى المرحلة</h2>
      </div>
      ...
      <div className="space-y-10">
        <section className="space-y-4 text-right">
          ...
          <div className="space-y-4">
            <p className="text-white/90 leading-7 whitespace-pre-line">{content || ""}</p>
          </div>
        </section>
      </div>
    </div>
