      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl mx-auto">
        ...
        >
          <CardHeader className="space-y-4">
            ...
            <CardDescription className="text-white/80">
              ارفع ملفك الدراسي، وهاش فلو يحوّله إلى مراحل تعلم منظمة. كل مرحلة
              مبنية بشكل تدريجي يساعدك على استيعاب المحتوى خطوة بخطوة بدل التشتت
              بين الصفحات.
            </CardDescription>
          </CardHeader>
          <CardFooter>
        ...
        <Card className="bg-[#33E2BD]/40 md:col-span-1 col-span-1 border-2 border-transparent hover:border-feature-green/50 transition-all duration-300 flex-col justify-between">
          <CardHeader className="space-y-4">
            ...
            <CardDescription className="text-white/80">
              ذكاء اصطناعي يفهم محتواك ويتفاعل معك بأسلوب تعليمي. اشرح، اسأل،
              ناقش، واطلب التبسيط أو الأمثلة كأنك تتعلّم مع مدرس ذكي متواجد معك
              دائمًا.
            </CardDescription>
          </CardHeader>
          <CardFooter>
        ...
        <Card className="bg-[#6E83F5]/40 md:col-span-1 col-span-1 border-2 border-transparent hover:border-feature-green/50 transition-all duration-300 flex-col justify-between">
          <CardHeader className="space-y-4">
            ...
            <CardDescription className="text-white/80">
              اختبارات ذكية تُنشأ تلقائيًا من محتواك الدراسي. تقيس فهمك الحقيقي،
              تكشف نقاط ضعفك، وتساعدك تستعد للاختبارات بثقة أكبر.
            </CardDescription>
          </CardHeader>
          <CardFooter>
            <Link
        ...
        <Card className="bg-[#BD6BEE]/40 md:col-span-2 col-span-1 border-2 border-transparent hover:border-feature-green/50 transition-all duration-300 flex-col justify-between">
          <CardHeader className="space-y-4">
            ...
            <div className="flex justify-between items-start">
              <CardTitle className="text-2xl text-white">
                التعلم من خلال البطاقات التعليمية
              </CardTitle>
            </div>
            <CardDescription className="text-white/80">
              حوّل المعلومات المهمة إلى بطاقات تعليمية سهلة للمراجعة والحفظ.
              مثالية للمذاكرة السريعة، التكرار الذكي، وتثبيت المعلومة في
              الذاكرة.
            </CardDescription>
          </CardHeader>
          <CardFooter>
