            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <CardHeader className="col-span-2">
                ...
                <CardDescription className="text-base text-white/80">
                  تفاعل مع ذكاء اصطناعي يفهم محتواك الدراسي بأسلوب تعليمي واضح.
                  اسأله، ناقشه، واطلب منه التبسيط أو الشرح بالأمثلة، وكأن عندك
                  مدرس خاص متواجد معك في أي وقت.
                </CardDescription>
              </CardHeader>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <CardHeader className="col-span-2">
                ...
                <CardDescription className="text-base text-white/80">
                  ارفع ملفاتك لذكاء الاصطناعي لتحويلها إلى مراحل تعليمية منظمة.
                  كل مرحلة مبنية بشكل تدريجي يساعدك على الفهم خطوة بخطوة بدل
                  التشتت بين الصفحات.
                </CardDescription>
              </CardHeader>
              <div className="bg-[#363843] col-span-2 h-[300px] py-6 relative overflow-hidden rounded-2xl">
