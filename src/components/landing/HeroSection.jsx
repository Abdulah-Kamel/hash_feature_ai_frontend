    ...
    <>
      <div className="flex flex-col items-center justify-center gap-8 w-full max-w-4xl mx-auto text-center  z-10">
        <div className="absolute inset-0 -z-10 h-full w-full">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 max-sm:w-[300px] sm:w-[800px] h-[800px] bg-primary/20 rounded-full blur-[120px] opacity-50"></div>
